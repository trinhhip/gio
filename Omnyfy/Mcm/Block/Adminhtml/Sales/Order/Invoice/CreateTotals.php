...
class CreateTotals extends \Magento\Framework\View\Element\Template
{
    ...
    public function initTotals()
    {
        ...
        $total = new \Magento\Framework\DataObject(
                    [
                'code' => 'shipping',
                'value' => $vendorInvoiceTotals['shipping_incl_tax'],
        ...
        $total = new \Magento\Framework\DataObject(
                ...
                'value' => $vendorInvoiceTotals['grand_total'] + $vendorInvoiceTotals['shipping_incl_tax'] - $vendorInvoiceTotals['shipping_discount_amount'],
                'label' => 'Grand Total',
                'area' => 'footer',        
                    ]
            );
