 ...
 */
namespace Omnyfy\VendorAuth\Block\Adminhtml\Integration\Edit\Tab;
...
class Info extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $integrationData['vendor_id'] = $this->getRequest()->getParam('vendor_id');
    ...
    /**
     * Add fieldset with Vendor ID integration information.
     *
     * @param \Magento\Framework\Data\Form $form
     * @param array $integrationData
     * @return void
     */
    protected function _addSelectVendorIdFieldset($form, $integrationData){
