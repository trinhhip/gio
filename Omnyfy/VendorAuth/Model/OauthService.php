...
use Omnyfy\VendorAuth\Model\Oauth\Token as OauthTokenModel;
use Omnyfy\VendorAuth\Model\Oauth\TokenFactory as TokenFactory;
 ...
 */
class OauthService implements \Omnyfy\VendorAuth\Api\OauthServiceInterface
{
    /**
