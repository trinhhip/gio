        ...
        if ($collectionSize) {
            try {
                foreach ($collection->getItems() as $item) {
                    ...
                    $item->setData('status', \Omnyfy\Approval\Model\Source\Status::STATUS_REVIEW_PASSED);
                    $product = $this->productRepository->getById($item->getProductId());
                    $product->setData('approval_status', \Omnyfy\Approval\Model\Source\Status::STATUS_REVIEW_PASSED);
