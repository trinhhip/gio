...
class SourceItemImporter extends \Magento\InventoryImportExport\Plugin\Import\SourceItemImporter
{
    /**
    ...
    public function __construct(
        ...
        parent::__construct($sourceItemsSave, $sourceItemFactory, $defaultSourceProvider);
    }
    ...
    public function afterImport(
        ...
        foreach ($stockData as $sku => $stockDatum) {
            ...
            $sourceItem->setSourceCode($stockDatum['source_code']);
