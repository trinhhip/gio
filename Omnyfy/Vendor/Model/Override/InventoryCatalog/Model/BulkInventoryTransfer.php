...
use Magento\InventoryCatalog\Model\ResourceModel\BulkZeroLegacyStockItem;
use Magento\Framework\Message\ManagerInterface as MessageManagerInterface;

class BulkInventoryTransfer extends \Magento\InventoryCatalog\Model\ResourceModel\BulkInventoryTransfer
{
     /**
    ...
    public function __construct(
        ...
        parent::__construct($resourceConnection, $getProductTypesBySkus, $isSourceItemManagementAllowedForProductType, $defaultSourceProvider, $setDataToLegacyStockItem, $bulkZeroLegacyStockItem);
    ...
    private function transferInventory(
        ...
        if ($orgSourceItem) {
            ...
            $this->messageManager->addErrorMessage(__('Product ' . $sku . ' wasn\'t assigned to Source ' . $originSource));
        }     
    }
