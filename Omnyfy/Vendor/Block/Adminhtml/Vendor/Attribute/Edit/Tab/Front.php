...
class Front extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            'select',
            [
                'name' => 'show_on_customer_emails',
                'label' => __("Show on customer and invoice emails"),
                'title' => __('Show on customer and invoice emails'),
                'note' => __('Cannot be used with input type Multiple Select'),
                'values' => $yesnoSource,
            ]
        );
