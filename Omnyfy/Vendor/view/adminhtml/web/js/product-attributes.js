define([
    ...
    'mage/utils/wrapper',
    'collapsable'
], function ($, alert, prompt, rg, wrapper) {
    'use strict';

    return function (switchDefaultValueField) {
        return wrapper.wrap(switchDefaultValueField, function (originalSwitchDefaultValueField, optionConfig) {
            var activePanelClass = 'selected-type-options',
                swatchProductAttributes = {
                    ...
                    showOnCustomerEmails: $('#show_on_customer_emails'),
                    ...
                    bindAttributeInputType: function () {
                        ...
                        if (!~$.inArray(this.frontendInput.val(), this.selectFields) || this.frontendInput.val() === 'boolean') {
                            // not in array
                        ...
                        if (this.frontendInput.val() === 'multiselect') {
                            this._disable(this.showOnCustomerEmails);
                        } else {
                            this._enable(this.showOnCustomerEmails);
                        }
                    ...
                    switchDefaultValueField: function () {
                        ...
                        } else if (optionConfig.hiddenFields[currentValue] && currentValue !== 'select') {
