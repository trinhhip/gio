...
class MassEnable extends \Omnyfy\Vendor\Controller\Adminhtml\AbstractAction
{
    ...
    public function execute()
    {
        ...
        if ($collection->getItems() > 0) {
            ...
            $this->messageManager->addSuccessMessage("Active $countSuccess Vendor Types successfully.");
        } else {
