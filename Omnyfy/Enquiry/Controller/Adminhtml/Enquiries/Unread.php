...
class Unread extends \Omnyfy\Enquiry\Controller\Adminhtml\Enquiries
{
        ...
        if ($id) {
            try {
                ...
                foreach($enquiries as $enquiry){
                    $enquiry->setStatus(\Omnyfy\Enquiry\Model\Enquiries\Source\Status::NEW_MESSAGE);
                    $enquiry->save();
                    // display success message
                    $this->messageManager->addSuccessMessage(__('Marked the enquiry unread.'));
                }

                return $resultRedirect->setPath('*/*/', ['enquiries_id' => $id]);
            }catch(\Exception $e) {
