...
class Archive extends \Omnyfy\Enquiry\Controller\Adminhtml\Enquiries
{
        ...
        if ($id) {
            try {
                ...
                foreach($enquiries as $enquiry){
                    $enquiry->setStatus(\Omnyfy\Enquiry\Model\Enquiries\Source\Status::ARCHIVE_MESSAGE);
                    $enquiry->save();
                    // display success message
                    $this->messageManager->addSuccessMessage(__('Marked the enquiry archive.'));
                }
