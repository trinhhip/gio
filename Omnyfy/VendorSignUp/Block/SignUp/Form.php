...
class Form extends Template {
	...
	public function getCountryCodes(){
        ...
        // get AllowedCountries in config admin
        $allowedCountries = $this->allowedCountryModel->getAllowedCountries();
        $result = array_intersect_key($countryArray, $allowedCountries);
        return $result;
	}
    ...
    public function getSelectWholeSale() {
        return $this->mcmConfig->getSelectWholeSale();
    }

    public function getWholeSaleQuestion() {
        return $this->mcmConfig->getWholeSaleQuestion();
    }
    ...
    public function displayFormWholeSale(){
    	return ($this->getEnableWholeSale() && $this->getSelectWholeSale());
    }

    public function getDefaultVendorPayout(){
    	return $this->mcmConfig->getDefaultVendorPayout();
    }
}
