            ...
            try {
				...
				if($roleId && $model->getId()){
					...
					$vendorData = array(
                        ...
                        'payout_basis_type' => $model->getPayoutBasisType()
						);
                    ...
                    $url = $this->backendUrl->getRouteUrl('adminhtml');
                    $vars = [
                    ...
                    $this->_dataHelper->sendSignUpApproveToCustomer($vars, $to);
                    // Sent email_sent to complete once notified
