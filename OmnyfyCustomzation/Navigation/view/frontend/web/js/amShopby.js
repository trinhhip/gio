...
define([
    ...
    $.widget('mage.amShopbyFilterAbstract', {
        ...
        formatNumberCommasToFloat: function (price) {
            return (price instanceof String || typeof price == 'string') ? parseFloat(price.replace(/,/g, '')) : price;
        }
    });
    ...
    $.widget('mage.amShopbyFilterSlider', $.mage.amShopbyFilterAbstract, {
        ...
        renderLabel: function (from, to) {
            from = $.mage.amShopbyFilterAbstract.prototype.formatPriceWithComma(parseFloat(from));
            to = $.mage.amShopbyFilterAbstract.prototype.formatPriceWithComma(parseFloat(to));
    ...
    $.widget('mage.amShopbyFilterFromTo', $.mage.amShopbyFilterAbstract, {
        ...
        onChange: function (event) {
            ...
            to = $.mage.amShopbyFilterAbstract.prototype.formatNumberCommasToFloat(to);
            from = $.mage.amShopbyFilterAbstract.prototype.formatNumberCommasToFloat(from);
            var fromToInterval = this.checkFromTo(from, to),
        ...
        applyFilter: function (e) {
            var to = $.mage.amShopbyFilterAbstract.prototype.formatNumberCommasToFloat(this.to.val()),
                from = $.mage.amShopbyFilterAbstract.prototype.formatNumberCommasToFloat(this.from.val()),
                fromToInterval = this.checkFromTo(from, to),
                priceFrom = $.mage.amShopbyFilterAbstract.prototype.formatNumberCommasToFloat(fromToInterval.from),
                priceTo = $.mage.amShopbyFilterAbstract.prototype.formatNumberCommasToFloat(fromToInterval.to),
                linkHref = this.options.url
                    .replace('amshopby_slider_from', priceFrom)
                    .replace('amshopby_slider_to', priceTo);
            this.apply(linkHref);
        ...
        onSyncChange: function (event, values) {
            ...
            from = $.mage.amShopbyFilterAbstract.prototype.formatPriceWithComma(from);
            to = $.mage.amShopbyFilterAbstract.prototype.formatPriceWithComma(to);
        ...
        checkFromTo: function (from, to) {
            ...
            // interval.from = $.mage.amShopbyFilterAbstract.prototype.formatNumberCommasToFloat(interval.from);
            // interval.to = $.mage.amShopbyFilterAbstract.prototype.formatNumberCommasToFloat(interval.to);
            return interval;
        },
        /**
    ...
    $.widget('mage.amShopbyFilterContainer', {
        ...
        toValidView: function (values) {
            values[0] = values[0] ? parseFloat(values[0]) : values[0];
            values[1] = values[1] ? parseFloat(values[1]) : values[1];
        ...
        checkIfValueNotExist: function (name, value) {
            ...
            $('[name="amshopby[' + name + '][]"]').each(function (index, item) {
                if (item.multiple && $(item).hasClass('am-select')) {
                    ...
                    if (multiSelectOptions.length && multiSelectOfixedptions.includes(value)) {
                        notExistValue = false;
                    }
                } else if (!item.value) {
                    notExistValue = false;
