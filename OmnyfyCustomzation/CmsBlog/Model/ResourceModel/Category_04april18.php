...
class Category extends AbstractDb
{
    ...
    public function __construct(
        Context $context, DateTime $dateTime, $resourcePrefix = null
    )
    {
    ...
    protected function _afterSave(AbstractModel $object)
    {
        ...
        ObjectManager::getInstance()->get('Psr\Log\LoggerInterface')->debug('$links ' . print_r($links, true));
        $linkType = 'article';
        ...
        ObjectManager::getInstance()->get('Psr\Log\LoggerInterface')->debug('$linksDataKeys ' . print_r($linksDataKeys, true));
        ObjectManager::getInstance()->get('Psr\Log\LoggerInterface')->debug('$oldIds ' . print_r($oldIds, true));
        ObjectManager::getInstance()->get('Psr\Log\LoggerInterface')->debug('$linksData ' . print_r($linksData, true));
