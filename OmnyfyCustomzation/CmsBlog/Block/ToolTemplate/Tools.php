...
class Tools extends Template
{
    ...
    public function getLogoUrl($toolIcon)
    {
        ...
        return $this->_storeManager->getStore()->getBaseUrl(UrlInterface::URL_TYPE_MEDIA) . $toolIcon;
    }
    ...
    public function getToolUrl($tool)
    {
        ...
        return $this->_storeManager->getStore()->getBaseUrl(UrlInterface::URL_TYPE_MEDIA) . $tool;
    }
